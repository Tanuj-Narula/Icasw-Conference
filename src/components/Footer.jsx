...
function Footer() {
  return (
    <div className="text-center mt-8 bottom-0 w-full p-4 bg-[#0C4f18] text-white text-sm">
      <p>
        In association with CENTRE FOR ENVIRONMENT AND CLIMATE CHANGE
      </p>
      ...
      <p>&copy; 2025 ICASW Conference. All Rights Reserved.</p>
    </div>
  );
}
