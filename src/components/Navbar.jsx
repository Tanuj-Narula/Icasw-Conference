  ...
  return (
    <div className="w-full h-auto">
      ...
      <div className="flex z-10 relative py-2 justify-between items-center bg-transparent w-full px-4">
        <Link to="/">
          <img
            ...
            alt="Logo"
            className="h-10 sm:h-20 md:h-24 lg:h-28 max-w-[100px] sm:max-w-[140px] lg:max-w-[160px] object-contain transition-transform duration-300 hover:scale-105"
          />
        </Link>
        ...
        <div className="text-center text-xl">
          <h2 className="text-xl font-bold hidden py-1 px-3 bg-[#087731c9] sm:inline rounded-lg">
            Hybrid
          </h2>
          ...
          <h1 className="text-5xl font-bold hidden sm:block">
            ICASW Conference 2025
          </h1>
          <h1 className="text-2xl font-bold block sm:hidden">ICASW </h1>
          <h1 className="text-base font-bold block sm:hidden">Conference </h1>
          <p className="text-sm sm:text-lg font-semibold hidden sm:block">
            Integrating Climate Action, AI, SDGs, and Water Management
          </p>
        ...
        <img
          src="/images/CSIR.png"
          alt="CSIR"
          className="h-10 sm:h-20 md:h-26 lg:h-28 max-w-[100px] sm:max-w-[140px] lg:max-w-[160px] object-contain rounded-full transition-transform duration-300 hover:scale-105"
        />
      ...
      <div className="marquee-text">
        <span>
          Welcome to ICASW Conference 2025! . . . . . . . . . . Registration is
          Now OPEN! . . . . . . . . . . Register NOW! . . . . . . . . . . 19th -
          20th March, 2025
        </span>
      </div>

      <div
        className={`sm:bg-[#4e9f4c] sm:shadow-md sm:border-none border-y-2 border-black shadow-green-900 sm:p-2 ${
        ...
        <ul className="flex sm:flex-row flex-col items-center sm:justify-around">
          <li>
            <NavLink
              ...
              to="/home"
              className={({ isActive }) =>
                `block py-4 px-4 font-bold text-base ${
              ...
              >
                <li className="group relative">
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      `block py-4 px-6 font-semibold text-gray-800 rounded-md transition-all duration-200 ${
                        isActive
