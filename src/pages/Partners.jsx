   ...
   <>
    <div className='h-auto flex flex-wrap items-center gap-y-20 text-sm sm:text-base justify-evenly text-center w-screen p-10 pt-16 '>
      <div className="flex flex-col items-center  gap-6 h-auto border p-6 rounded-md w-auto sm:w-[20vw] hover:shadow-md hover:cursor-pointer" >
        <img src="/images/KTH.png" alt="KTH" className="rounded-lg sm:h-[150px]" />
      ...
      <div className="flex flex-col items-center gap-6 h-auto border p-6 rounded-md w-auto sm:w-[20vw] hover:shadow-md hover:cursor-pointer" >
        <img src="/images/ISGSD.png" alt="ISGCD" className="rounded-lg sm:h-[150px]" />
      ...
      <div className="flex flex-col items-center gap-6 h-auto border p-6 rounded-md w-auto sm:w-[20vw] hover:shadow-md hover:cursor-pointer" >
        <img src="/images/DTU.png" alt="DTU" className="rounded-lg sm:h-[150px]" />
        <p>Delhi Technological University (DTU)</p>
      </div>
      <div className="flex flex-col items-center gap-6 h-auto border p-6 rounded-md w-auto sm:w-[20vw] hover:shadow-md hover:cursor-pointer" >
        <img src="/images/jnu.jpeg" alt="jnu" className="rounded-lg sm:h-[150px]" />
        <p>Jawaharlal Nehru University (jnu)</p>
      </div>
      <div className="flex flex-col items-center gap-6 h-auto border p-6 rounded-md w-auto sm:w-[20vw] hover:shadow-md hover:cursor-pointer" >
        <img src="/images/ministry_of_environment.webp" alt="moefcc" className="rounded-lg sm:h-[180px]" />
