...
function SchoolOfEngineering() {
  return (
    <div className='h-auto sm:text-justify px-10 mt-5'>
      ...
      <div className='mt-16'>
        <h1 className="inline font-bold text-lg sm:text-2xl bg-yellow-300 border-black border-2 p-2 text-black rounded-[7px] shadow-heading">About the Department</h1>
        <p className='mt-8'>
